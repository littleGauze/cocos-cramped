...
const BASE_URL = 'texture/ironskeleton'

export type IronSkeletonResourceType = 'idle' | 'death' | 'attack'

export default class IronSkeletonSubStateMachine extends DirectionSubStateMachine {
  constructor(
    fsm: StateMachine,
    type: IronSkeletonResourceType,
